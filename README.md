# Kinde Starter Kit - Ruby

This is a Ruby template with [KindeAuth](https://github.com/kinde-oss/kinde-ruby-sdk).
...
Clone this repo and install dependencies by running `bundle`
...
KINDE_MANAGEMENT_CLIENT_ID=<clinet_id>
